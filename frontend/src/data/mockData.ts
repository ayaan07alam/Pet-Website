...
// ─────────────────────────────────────────────
//  MOCK PETS — Client Inventory (accurate images)
// ─────────────────────────────────────────────
...
export const mockPets: Pet[] = [
  ...
  },
  {
    ...
    // Racing/performance pigeons on a rooftop
  ...
  // Exotic Finches
  {
    ...
    // Gouldian finch - rainbow coloured
    image: 'https://images.unsplash.com/photo-1609524775596-3d6d1a1f7ec2?w=600&q=80',
  ...
  // Conures
  {
    ...
    // Sun conure - orange/yellow parrot
  ...
  },
  {
    ...
    // Green parrot with blue markings
  ...
  },
  {
    ...
    // Blue and gold/yellow macaw
    image: 'https://images.unsplash.com/photo-1508459855340-fb63ac591728?w=600&q=80',
  ...
  // Amazon
  {
    ...
    // Green amazon parrot with blue forehead
  ...
  },
  {
    ...
    // Green amazon parrot with yellow head
  ...
  // Lorikeet
  {
    ...
    // Rainbow lorikeet - red, blue, green, yellow
  ...
  // Eclectus
  {
    ...
    // Eclectus parrot - bright green male
  ...
  // Budgies
  {
    ...
    // Budgerigar / budgie blue and white
  ...
  // Cockatiels
  {
    ...
    // Grey cockatiel with yellow crest
    image: 'https://images.unsplash.com/photo-1591198936750-16d8e15edb9e?w=600&q=80',
    rating: 4.7, reviews: 55, available: true, category: 'birds',
  ...
  },
  {
    ...
    // Yellow/white cockatiel lutino
    image: 'https://images.unsplash.com/photo-1522858547137-f1dcec554f55?w=600&q=80',
  ...
  },
  {
    ...
    description: "Australia's iconic flightless bird. Curious and surprisingly friendly when hand-reared. Requires large outdoor space. Farm/property required.",
  },
...

  {
    ...
    description: 'Tiny, adorable, and lightning-fast! Roborovski dwarfs are the smallest hamsters. Perfect for watching. Social — best in same-sex pairs.',
  },
  {
    id: 'rod-sh-01', name: 'Syrian Hamster', breed: 'Syrian Hamster (Golden)',
    species: 'rodent', age: '8 weeks', gender: 'Male', price: 1200,
    // Golden/brown syrian hamster
  ...
  },
  {
    ...
    // White and coloured fancy mouse
    image: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=600&q=80',
    rating: 4.3, reviews: 30, available: true, category: 'rodents',
    description: 'Colourful, lively fancy mice in various coat colours and patterns. Social and entertaining to watch. Inexpensive to keep.',
  },
  {
    id: 'rod-dg-01', name: 'Degu', breed: 'Octodon degus',
    species: 'rodent', age: '8 weeks', gender: 'Female', price: 2500,
    // Degu - chipmunk-like brown rodent
    image: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?w=600&q=80',
...

  {
    ...
    image: 'https://images.unsplash.com/photo-1597214860882-b60a5b13f9be?w=600&q=80',
  ...
  },
  {
    ...
    description: 'The most popular pet snake in the world. Docile, manageable, and beautifully patterned. Captive-bred, healthy, and feeding on frozen-thawed.',
  },
  {
    id: 'rep-cs-01', name: 'Corn Snake', breed: 'Pantherophis guttatus',
    species: 'reptile', age: '6 months', gender: 'Male', price: 9000,
    // Corn snake - orange and red pattern
  ...
  },
  {
    ...
    // Hognose snake with upturned snout
...

  {
    ...
    description: 'The most popular aquatic turtle in the world. Bright red ear patches and an olive-green shell. Thrives in a well-maintained tank with basking area.',
  },
  {
...

  {
    ...
    // Siberian cat - large fluffy grey/brown
    image: 'https://images.unsplash.com/photo-1494256997604-768d1f608cac?w=600&q=80',
  ...
  },
  {
    ...
    // Exotic longhair flat-faced fluffy cat
  ...
  },
  {
    ...
    // Ragdoll - blue eyes, point coloured
  ...
  },
  {
    ...
    // Siamese - cream with dark points, blue eyes
  ...
  },
  {
    ...
    species: 'cat', age: '3 months', gender: 'Female', price: 42000,
    // British shorthair - grey/blue plush round cat
  ...
  },
  {
    ...
    // Scottish fold - folded ears, round face
  ...
  },
  {
    ...
    // Exotic shorthair - flat face, dense plush coat
  ...
  },
  {
    ...
    // Maine coon - large, tufted ears, fluffy mane
  ...
  },
  {
    ...
    description: 'Wild leopard markings with a domestic temperament. Athletic, playful, and endlessly energetic. Loves climbing and water. SBT (5th generation+).',
  },
  {
    id: 'cat-ps-01', name: 'Persian Kitten', breed: 'Persian',
    species: 'cat', age: '3 months', gender: 'Female', price: 38000,
    // Persian - flat face, long fluffy white coat
...
export const mockProducts = [
  ...
  },
  {
    ...
    description: 'Running water encourages cats to drink more, promoting kidney health. 2-litre capacity, quiet pump, replaceable carbon filter.',
  },
  {
    ...
    description: 'Safety breakaway buckle releases under pressure, preventing strangulation. Adjustable, lightweight, available in multiple colours with bell.',
  },
  {
  ...
  },
  {
    ...
    description: '5-level activity centre: sisal scratching posts, two plush hammocks, a top perch, and interactive hanging toys.',
  },
  {
  ...
  },
  {
    ...
    description: 'Large hooded litter box with carbon filter flap — keeps odour and scatter controlled. Smooth interior for easy cleaning.',
  },
  {
    ...
    description: 'Premium clumping bentonite litter. 99% dust-free, odour-neutralising. Tight clumps for easy scooping. Unscented and natural.',
  },
  {
  ...
  },
  {
    ...
    description: 'Tall natural sisal post on a weighted wooden base. Satisfies scratching instincts and protects furniture. Comes with a dangling toy.',
  },
  {
    ...
    description: 'Thai-origin cat food approved by Indian vets. High chicken protein, balanced omega-3/6 for coat health.',
  },
  {
  ...
  },
  {
    ...
    description: 'Grain-free formula for cats with sensitive stomachs. High meat content (70%+), no wheat, corn, or soy.',
  },
  {
  ...
  },
  {
    ...
    description: 'Heavy-gauge wire cat cage with 4 levels, ramps, hammocks, and litter tray space. Collapsible for easy storage and transport.',
  },
  ...
  // ── PIGEON ACCESSORIES ──
  {
    ...
    description: 'Self-refilling water feeder with gravity-fed mechanism. Holds 500ml of water. Easy to clean and attach to cage bars.',
  },
  {
  ...
  },
  {
    ...
    description: 'Large 60cm hamster home with silent spinner wheel, coloured tubes, hideout, and food dish. Deep plastic base for burrowing.',
  },
...
// ─────────────────────────────────────────────
//  MOCK CATEGORIES — with accurate hero images
// ─────────────────────────────────────────────
...
export const mockCategories = [
  {
    ...
    count: 21,
    description: 'Macaws, Conures, Cockatoos, Pigeons & more',
    color: '#E8A020',
  ...
  },
  {
    id: 'cats',
    name: 'Exotic Cats',
    // Closeup persian/exotic cat face
